...
<head>
    ...
    <link rel="icon" href="{{ asset('images/logo.ico') }}" sizes="32x32">
    <link rel="icon" href="{{ asset('images/logo.ico') }}" sizes="64x64">
    <link rel="icon" href="{{ asset('images/logo.ico') }}" sizes="128x128">
