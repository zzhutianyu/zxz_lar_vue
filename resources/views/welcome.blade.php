...
<head>
    ...
    <meta rel="icon" href="{{ asset('images/logo.ico') }}" sizes="32x32">
    <meta rel="icon" href="{{ asset('images/logo.ico') }}" sizes="64x64">
    <meta rel="icon" href="{{ asset('images/logo.ico') }}" sizes="128x128">
